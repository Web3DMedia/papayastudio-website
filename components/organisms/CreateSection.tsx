   ...
   return (
      <section className="relative w-full py-28 md:py-32  xl:py-48 4xl:pt-36" id="WhatWeDo">
         ...
         <div className="2xl:w-[1440px] m-auto">
            ...
            <p className="absolute left-5 md:left-14 -top-[20px] sm:-top-[60px] lg:left-20 xl:left-[80px] md:-top-[50px] xl:-top-[115px] 4xl:-top-16 4xl:left-20 font-normal text-xs uppercase">
               What We <br/> Do
            </p>
            <div className="h-full w-full ">
               <h2 className="text-[24px] leading-tight md:text-[32px] lg:text-[36px] xl:text-[48px] font-bold pl-5 md:pl-14 lg:pl-0 md:pt-12 xl:pt-0">We create blockchain <br/>
and web3 focused:</h2>
               <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 mt-5 px-5 md:pl-14 lg:pl-[0px] lg:px-0">
                  {
